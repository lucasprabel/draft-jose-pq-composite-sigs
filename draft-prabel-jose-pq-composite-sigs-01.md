...
In this document, unlike {{-COSE-MLDSA}} but as in {{-COSE-MLDSA}}, the ML-DSA private key MUST be a 32-byte seed.
...
| | Private Key | Private Key | Public Key | Signature Size |
| ----------- | ----------- | ----------- | ----------- |
